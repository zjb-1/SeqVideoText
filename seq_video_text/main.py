...
def get_args_parser():
    ...
    parser.add_argument('--iter_param_save_step', default=-1, type=int)
    ...
    parser.add_argument('--ytvis_path', default=None, type=str)
    parser.add_argument('--train_img_prefix', nargs='+')
    parser.add_argument('--train_ann_file', nargs='+')
    parser.add_argument('--test_img_prefix', default=None, type=str)
    parser.add_argument('--test_ann_file', default=None, type=str)
...
def main(args):
    ...
    # base_ds = {}
    #
    # if args.dataset_file == 'YoutubeVIS' or args.dataset_file == 'VideoText' or args.dataset_file == 'jointcoco' or args.dataset_file == 'Seq_coco':
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, criterion, data_loader_train, optimizer, device, epoch, output_dir, args.clip_max_norm,
            args.iter_param_save_step)
        lr_scheduler.step()
        if args.output_dir:
